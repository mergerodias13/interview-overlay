...
namespace InterviewOverlay
{
    public partial class MainWindow : Window
    {
        ...
        {
            // Force the ListBox to re-evaluate ToString() for the selected item.
        ...
        {
            // "Open Notes" simply focuses the editor for the selected profile;
            // profile switching happens via the list on the left.
            NotesEditor.Focus();
        }
